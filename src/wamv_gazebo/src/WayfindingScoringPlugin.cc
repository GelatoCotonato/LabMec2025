 ...
 * Copyright (C) 2025 Honu Robotics
 *
...
class WayfindingScoringPlugin::Implementation
{
  ...
  public: std::string waypointsTopic = "/wamv_gazebo/wayfinding/waypoints";

  /// \brief Topic where the current minimum pose error distance for each
  /// waypoint is published.
  public: std::string minErrorsTopic = "/wamv_gazebo/wayfinding/min_errors";

  /// \brief Topic where the current average minimum error is published.
  public: std::string meanErrorTopic = "/wamv_gazebo/wayfinding/mean_error";
...
GZ_ADD_PLUGIN_ALIAS(wamv_gazebo::WayfindingScoringPlugin,
                    "wamv_gazebo::WayfindingScoringPlugin")
