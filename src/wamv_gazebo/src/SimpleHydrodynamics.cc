...
class wamv_gazebo::SimpleHydrodynamicsPrivate
{
...
GZ_ADD_PLUGIN(wamv_gazebo::SimpleHydrodynamics,
              sim::System,
              SimpleHydrodynamics::ISystemConfigure,
              SimpleHydrodynamics::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(wamv_gazebo::SimpleHydrodynamics,
                    "wamv_gazebo::SimpleHydrodynamics")
