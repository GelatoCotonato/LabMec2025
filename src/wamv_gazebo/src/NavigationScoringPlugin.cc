...
GZ_ADD_PLUGIN(wamv_gazebo::NavigationScoringPlugin,
                    sim::System,
                    wamv_gazebo::NavigationScoringPlugin::ISystemConfigure,
                    wamv_gazebo::NavigationScoringPlugin::ISystemPreUpdate)
