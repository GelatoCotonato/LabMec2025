  ...
  sim::EntityComponentManager &_ecm, sim::EventManager &_eventMgr)
{
  ...
  this->dataPtr->node.Subscribe("/wamv_gazebo/gymkhana_channel/task/info",
    &GymkhanaScoringPlugin::ChannelCallback, 
    this);

  this->dataPtr->node.Subscribe("/wamv_gazebo/gymkhana_blackbox/task/info",
...
GZ_ADD_PLUGIN_ALIAS(wamv_gazebo::GymkhanaScoringPlugin,
                    "wamv_gazebo::GymkhanaScoringPlugin")
