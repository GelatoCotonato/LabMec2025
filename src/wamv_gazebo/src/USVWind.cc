...
public:
  std::string topicWindSpeed = "/wamv_gazebo/debug/wind/speed";

  /// \brief Topic where the wind direction is published
public:
  std::string topicWindDirection = "/wamv_gazebo/debug/wind/direction";
...
GZ_ADD_PLUGIN(wamv_gazebo::USVWind,
              sim::System,
              USVWind::ISystemConfigure,
              USVWind::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(wamv_gazebo::USVWind,
                    "wamv_gazebo::USVWind")
