...
class AcousticTrackingScoringPlugin::Implementation
{
  ...
  public: std::string poseErrorTopic = "/wamv_gazebo/acoustic_wayfinding/pose_error";

  /// \brief Topic where mean pose error is published.
  public: std::string meanErrorTopic =
    "/wamv_gazebo/acoustic_wayfinding/mean_pose_error";
};
...
GZ_ADD_PLUGIN(wamv_gazebo::AcousticTrackingScoringPlugin,
              sim::System,
              wamv_gazebo::AcousticTrackingScoringPlugin::ISystemConfigure,
              wamv_gazebo::AcousticTrackingScoringPlugin::ISystemPreUpdate)
