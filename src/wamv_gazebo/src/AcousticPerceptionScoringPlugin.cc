...
GZ_ADD_PLUGIN(wamv_gazebo::AcousticPerceptionScoringPlugin,
              sim::System,
              wamv_gazebo::AcousticPerceptionScoringPlugin::ISystemConfigure,
              wamv_gazebo::AcousticPerceptionScoringPlugin::ISystemPreUpdate)
