...
class StationkeepingScoringPlugin::Implementation
{
  ...
  public: std::string goalTopic = "/wamv_gazebo/stationkeeping/goal";

  /// \brief Topic where 2D pose error is published
  public: std::string poseErrorTopic = "/wamv_gazebo/stationkeeping/pose_error";

  /// \brief Topic where mean pose error is published.
  public: std::string meanErrorTopic = "/wamv_gazebo/stationkeeping/mean_pose_error";
...
GZ_ADD_PLUGIN(wamv_gazebo::StationkeepingScoringPlugin,
              sim::System,
              wamv_gazebo::StationkeepingScoringPlugin::ISystemConfigure,
              wamv_gazebo::StationkeepingScoringPlugin::ISystemPreUpdate)
