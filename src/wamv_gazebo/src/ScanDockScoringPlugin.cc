...
class DockChecker
{
  ...
  private: std::string symbolTopic = "/wamv_gazebo/scan_dock/placard_symbol";
  ...
  const std::string _vehicleName)
{
  ...
  std::string colorSequenceTopic = "/wamv_gazebo/scan_dock/color_sequence";
...
GZ_ADD_PLUGIN_ALIAS(wamv_gazebo::ScanDockScoringPlugin,
                    "wamv_gazebo::ScanDockScoringPlugin")
