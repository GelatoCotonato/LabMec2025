...
def generate_launch_description(world_name="sydney.world"):

    # Get directories
    bringup_dir = get_package_share_directory('wamv_bringup')
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(sim_dir, 'worlds', world_name),
        description='Full path to world model file to load',
    )

    # TO DO define urdf of robot
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name', default_value='wamv', description='name of the robot'
    )

    # TO DO define urdf of robot
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(sim_dir, 'models', 'wam-v', 'model.sdf'),
        description='Full path to robot sdf file to spawn the robot in gazebo',
    )

    # TO DO indicare il path del modello del robot
