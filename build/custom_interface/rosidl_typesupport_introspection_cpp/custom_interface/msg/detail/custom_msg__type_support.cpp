...
{
  new (message_memory) custom_interface::msg::CustomMsg(_init);
}

void CustomMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interface::msg::CustomMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMsg_message_member_array[2] = {
  {
    ...
    offsetof(custom_interface::msg::CustomMsg, index),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interface::msg::CustomMsg, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interface::msg::CustomMsg),
...
get_message_type_support_handle<custom_interface::msg::CustomMsg>()
{
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, msg, CustomMsg)() {
  return &::custom_interface::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}
